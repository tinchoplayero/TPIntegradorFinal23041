...
<div class="container-fluid divisor" id="conv-orador">
        <div class="text-center">
          ...
          %>
                    <form class="row offset-2 col-8" action="editaOradores.jsp">
                    <div class="col mb-3">
                    ...
                    <div class="col">
                      ...
                      <select type="text" class="form-control" placeholder="" id="confirmaOrador" name="confirmaOrador" value="<%= activo %>">
                    ...
                    <div class="col">
					    <input type="hidden" name="idOrador" value="<%= idOrador %>">
					 </div>
					 <div class="col">
					    <button type="submit" class="btn btn-enviar">Confirmar Cambios</button>
